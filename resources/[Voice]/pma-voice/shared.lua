...
if GetConvar('voice_useNativeAudio', 'false') == 'true' then
    ...
    Cfg.voiceModes = {
        { 2.00, "Whisper" }, -- Whisper speech distance in gta distance units
        { 5.50, "Normal" }, -- Normal speech distance in gta distance units
        { 10.00, "Shouting" }, -- Shout speech distance in gta distance units
        --{ 1000000.0, "Global Admin"}
    }
else
    Cfg.voiceModes = {
        { 2.00,  "Whisper" }, -- Whisper speech distance in gta distance units
