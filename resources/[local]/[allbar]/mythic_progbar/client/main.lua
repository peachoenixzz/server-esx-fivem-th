...
function HelpNotify(action, finish)
...
RegisterNetEvent("mythic_progbar:client:HelpNotify")
AddEventHandler("mythic_progbar:client:HelpNotify", function(action, start, tick, finish)
    HelpNotify(action, finish)
end)
