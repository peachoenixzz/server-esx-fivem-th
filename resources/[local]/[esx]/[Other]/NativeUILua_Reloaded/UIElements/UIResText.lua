...
Citizen.CreateThread(function()
    RegisterFontFile('Mitr') -- the name of your .gfx, without .gfx
    fontId = RegisterFontId('Mitr') -- the name from the .xml
end)
local GetCustomFont = function()
    return fontId
end
function UIResText:Draw()
    local fontId = GetCustomFont()
