...
Config.Weapons = {
	-- Melee
	{name = 'WEAPON_DAGGER', label = 'Dagger Lv.1', components = {}},
	{name = 'WEAPON_BAT', label = 'Bat Lv.3', components = {}},
	{name = 'WEAPON_BAT_1H', label = 'Bat Lv.1', components = {}},
	...
	{name = 'WEAPON_BOTTLE', label = 'Bottle Lv.1', components = {}},
	...
	{name = 'WEAPON_GOLFCLUB', label = 'Golf Club Lv.3', components = {}},
	{name = 'WEAPON_GOLFCLUB_1H', label = 'Golf Club Lv.1', components = {}},
	...
	{name = 'WEAPON_KNIFE', label = 'Knife Lv.1', components = {}},
	{name = 'WEAPON_MACHETE', label = 'Machete Lv.1', components = {}},
	...
	{name = 'WEAPON_POOLCUE', label = 'PoolCue Lv.1', components = {}},
	{name = 'WEAPON_POOLCUE_B', label = 'Pool Cue', components = {}},
	{name = 'WEAPON_POOLCUE_G', label = 'Pool Cue', components = {}},
	...
	{name = 'WEAPON_CANDYAXE', label = 'CandyAxe', components = {}},
	{name = 'WEAPON_BOTTLE_NP', label = "Bottle Newbie", components = {}},
	{name = 'WEAPON_HAMMER_NP', label = "Hammer Newbie", components = {}},
	{name = 'WEAPON_BOTTLE_SOS', label = "Bottle", components = {}},
	{name = 'WEAPON_BOTTLE_PUNK', label = "Bottle Punk", components = {}},
	{name = 'WEAPON_POOLCUE_PUNK', label = "Poolcue Punk", components = {}},
	{name = 'WEAPON_BAT_PUNK', label = "Bat Punk", components = {}},
	{name = 'WEAPON_GOLFCLUB_PUNK', label = "Golf Club Punk", components = {}},
	{name = 'WEAPON_MACHETE_PUNK', label = "Machete Punk", components = {}},
	{name = 'WEAPON_KNIFE_PUNK', label = "Knife Punk", components = {}},
	{name = 'WEAPON_HAMMER_PUNK', label = "Hammer Punk", components = {}},
	{name = 'WEAPON_KNUCKLE_PUNK', label = "Knuckle Punk", components = {}},
	{name = 'WEAPON_DAGGER_PUNK', label = "Dagger Punk", components = {}},
	-- Lv Weapon
	{name = 'WEAPON_BAT_1H_2', label = "Bat Lv.2", components = {}},
	{name = 'WEAPON_GOLFCLUB_1H_2', label = "Golf Club Lv.2", components = {}},
	{name = 'WEAPON_KNUCKLE_2', label = "Knuckle Lv.2", components = {}},
	{name = 'WEAPON_KNUCKLE_3', label = "Knuckle Lv.3", components = {}},
	{name = 'WEAPON_KNUCKLE_4', label = "Knuckle Lv.4", components = {}},
	{name = 'WEAPON_KNUCKLE_5', label = "Knuckle Lv.5", components = {}},
	{name = 'WEAPON_MACHETE_2', label = "Machete Lv.2", components = {}},
	{name = 'WEAPON_MACHETE_3', label = "Machete Lv.3", components = {}},
	{name = 'WEAPON_BOTTLE_2', label = "Bottle Lv.2", components = {}},
	{name = 'WEAPON_BOTTLE_3', label = "Bottle Lv.3", components = {}},
	{name = 'WEAPON_KNIFE_2', label = "Knife Lv.2", components = {}},
	{name = 'WEAPON_KNIFE_3', label = "Knife Lv.3", components = {}},
	{name = 'WEAPON_DAGGER_2', label = "Dagger Lv.2", components = {}},
	{name = 'WEAPON_DAGGER_3', label = "Dagger Lv.3", components = {}},
	{name = 'WEAPON_POOLCUE_2', label = "PoolCue Lv.2", components = {}},
	{name = 'WEAPON_POOLCUE_3', label = "PoolCue Lv.3", components = {}},
	-- Arena Weapon
	{name = 'R_WEAPON_BOTTLE', label = "Bottle (เช่า)", components = {}},
	{name = 'R_WEAPON_POOLCUE', label = "Poolcue (เช่า)", components = {}},
	{name = 'R_WEAPON_BAT', label = "Bat (เช่า)", components = {}},
	{name = 'R_WEAPON_GOLFCLUB', label = "Golf Club (เช่า)", components = {}},
	{name = 'R_WEAPON_MACHETE', label = "Machete (เช่า)", components = {}},
	{name = 'R_WEAPON_KNIFE', label = "Knife (เช่า)", components = {}},
	{name = 'R_WEAPON_KNUCKLE', label = "Knuckle (เช่า)", components = {}},
	{name = 'R_WEAPON_DAGGER', label = "Dagger (เช่า)", components = {}},
	-- T1 Weapon
	{name = 'T1_WEAPON_MACHETE', label = "Machete (T1)", components = {}},
	{name = 'T1_WEAPON_BOTTLE', label = "Bottle (T1)", components = {}},
	{name = 'T1_WEAPON_KNUCKLE', label = "Knuckle (T1)", components = {}},
	{name = 'T1_WEAPON_POOLCUE', label = "Poolcue (T1)", components = {}},
	-- [SKY] GOLD Weapon --
	----- POOL -----
	{name = 'WEAPON_POOLGOLD', label = ('ไม้พูลเทพ'), components = {}},
	{name = 'WEAPON_POOLGOLD_G', label = ('POOLGOLD_G'), components = {}},
	{name = 'WEAPON_POOLGOLD_P', label = ('POOLGOLD_P'), components = {}},
	{name = 'WEAPON_POOLGOLD_R', label = ('POOLGOLD_R'), components = {}},
	----- MACHETTE -----
	{name = 'WEAPON_MACHETTEGOLD', label = ('มาเชเต้เทพ'), components = {}},
	{name = 'WEAPON_MACHETTEGOLD_G', label = ('MACHETTEGOLD_G'), components = {}},
	{name = 'WEAPON_MACHETTEGOLD_P', label = ('MACHETTEGOLD_P'), components = {}},
	{name = 'WEAPON_MACHETTEGOLD_R', label = ('MACHETTEGOLD_R'), components = {}},
	----- KNUCKLE -----
	{name = 'WEAPON_KNUCKLEGOLD', label = ('สนับมือเทพ'), components = {}},
	{name = 'WEAPON_KNUCKLEGOLD_G', label = ('KNUCKLEGOLD_G'), components = {}},
	{name = 'WEAPON_KNUCKLEGOLD_P', label = ('KNUCKLEGOLD_P'), components = {}},
	{name = 'WEAPON_KNUCKLEGOLD_R', label = ('KNUCKLEGOLD_R'), components = {}},
	----- KNIFE -----
	{name = 'WEAPON_GUTKNIFELPGOLD', label = ('มีดเทพ'), components = {}},
	{name = 'WEAPON_GUTKNIFELPGOLD_G', label = ('GUTKNIFELPGOLD_G'), components = {}},
	{name = 'WEAPON_GUTKNIFELPGOLD_P', label = ('GUTKNIFELPGOLD_P'), components = {}},
	{name = 'WEAPON_GUTKNIFELPGOLD_R', label = ('GUTKNIFELPGOLD_R'), components = {}},
	----- SOS -----
	{name = 'WEAPON_KNIFE_SOS', label = ('มีด'), components = {}},
	{name = 'WEAPON_POOLCUE_SOS', label = ('ไม้พูล'), components = {}},
	-- Handguns
	{
	...
	{
		name = 'WEAPON_REVOLVER_MK2_CC',
		label = TranslateCap('weapon_revolver_mk2_cc'),
		ammo = {label = TranslateCap('ammo_rounds'),hash = `AMMO_PISTOL`},
		tints = Config.DefaultWeaponTints,
		components = {
			{name = 'clip_default', label = TranslateCap('component_clip_default'), hash = `COMPONENT_REVOLVER_MK2_CLIP_01`},
	...
	{name = 'WEAPON_STUNGUN2', label = 'weapon_stungun2', tints = Config.DefaultWeaponTints, components = {}},
	{name = 'WEAPON_GADGETPISTOL2', label = 'Gadget Pistol2', tints = Config.DefaultWeaponTints, components = {}},
	-- Shotguns
	{
