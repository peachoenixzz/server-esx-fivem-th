...
RegisterNetEvent('esx:spawnCirclePlayer')
AddEventHandler('esx:spawnCirclePlayer',function()
	...
	TriggerEvent('esx:restoreLoadout')
		...
		Citizen.Wait(1500)
		if skinTemp ~= nil or skinTemp ~= '' then
			TriggerEvent('skinchanger:loadSkin', skinTemp)
		end
	...
	SetMaxWantedLevel(0)
	Citizen.Wait(6000)
	TriggerEvent('orcp_postal_map:loadingmap')
	...
	--NetworkResurrectLocalPlayer(ESX.PlayerData.coords.x, ESX.PlayerData.coords.y, ESX.PlayerData.coords.z, 1.0, true, true, false)
	SetEntityCoordsNoOffset(PlayerPedId(),ESX.PlayerData.coords.x,ESX.PlayerData.coords.y,ESX.PlayerData.coords.z+1,false, false, false,true)
	local time = GetGameTimer()
	while (not HasCollisionLoadedAroundEntity(PlayerPedId()) and (GetGameTimer() - time) < 40000) do
		RequestCollisionAtCoord(ESX.PlayerData.coords.x, ESX.PlayerData.coords.y, ESX.PlayerData.coords.z)
		Citizen.Wait(0)
	end
