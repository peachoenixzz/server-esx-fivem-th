...
Config.ProcessingZone = {
	...
	Coal = {
		...
		Marker = {
			Type = -1,
			Pos = {
				x = -55.4312, y = 1890.8401,z = 195.3981,
				h = 100.4564,
			},
			Color = {
				r = 0,
	...
	Ruby = {
		...
		Blips = {
			...
			Color = 0,		---- สีจุดถ้าแก้แล้วแนะนำให้เป็น 0
			Size = 1.0,
			Text ='<font face="font4thai">แปรรูปรูบี้</font>',
		},
		Marker = {
			Type = -1,
			Pos = {
				x = -2286.4692, y = 365.2287, z = 174.6016,
				h = 20.4803,
			},
			Color = {
				r = 0,
	...
	Diamond = {
		...
		Blips = {
			...
			Color = 0,		---- สีจุดถ้าแก้แล้วแนะนำให้เป็น 0
			Size = 1.0,
			Text ='<font face="font4thai">แปรรูปเพชร</font>',
		},
		Marker = {
			Type = -1,
			Pos = {
				x = -2293.8804, y = 361.9295, z = 174.6016,
				h = 27.5665,
			},
			Color = {
				r = 0,
