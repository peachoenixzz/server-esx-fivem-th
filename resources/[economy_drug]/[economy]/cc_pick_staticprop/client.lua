...
RegisterNetEvent('cc_pick_staticprop:overWeight')
AddEventHandler('cc_pick_staticprop:overWeight', function ()
	IsPickingUp = false
	ongoingAutofarmStatic = false
	exports.cc_sound:initSound('warningafkfarm', 'local')
	exports.helpnotify:hideHelpNotification()
	ClearPedTasks(PlayerPedId())
	SetPedKeepTask(
			PlayerPedId() --[[ Ped ]],
	...
	--TriggerEvent('cc_sound:playSound', 'warningafkfarm')
end)
