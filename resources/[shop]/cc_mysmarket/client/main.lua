...
Citizen.CreateThread(function()
    ...
    npcPed = CreatePed(4, npcHash,  216.02999877929688, -914.1400146484376, 29.97999954223632, 65.32, false, true)
...
local recycleZone = PolyZone:Create({
	vector3(216.4199981689453, -913.3499755859376, 30.98999977111816),
	vector3(215.1300048828125, -912.5900268554688, 30.98999977111816),
	vector3(214.44000244140625, -913.9600219726564, 30.97999954223632),
	vector3(216.22000122070312, -915, 30.92000007629394),
},{
    name = "recycle_zone",
    debugPoly = false,
    minZ = 29,
