...
function loadScene(x, y, z)
    ...
    -- handle load first position in game
    NewLoadSceneStart(x, y, z, -424.4500122070313, 1147.8199462890625, 327.1600036621094, 20.0, 0)
...
function spawnPlayer(spawnIdx, cb)
    ...
    Citizen.CreateThread(function()
        ...
        SetEntityCoordsNoOffset(ped, spawn.x, spawn.y, spawn.z+1, false, false, false, true)

        NetworkResurrectLocalPlayer(spawn.x, spawn.y, spawn.z+1, spawn.heading, true, true, false)
