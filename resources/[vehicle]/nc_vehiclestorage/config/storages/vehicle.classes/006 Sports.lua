...
Config.Storages.Classes['Sports'] = {
	['inside'] = {								-- ช่องเก็บของภายในรถ
		allowed_seats = { -1, 0 },				-- ที่นั่งที่สามารถใช้งานช่องเก็บของภายในยานพาหนะได้
		slot = 5,								-- จำนวนช่องทั้งหมดที่สามารถเก็บสิ่งของได้
		weight = 0,								-- จำนวนน้ำหนักทั้งหมดที่สามารถเก็บสิ่งของได้
		total_account_limit = 10000,			-- จำนวนสูงสุดของสิ่งของประเภทเงินที่สามารถเก็บได้ (-1 : ไม่จำกัด)
		total_item_limit = 10,					-- จำนวนสูงสุดของสิ่งของทั่วไปที่สามารถเก็บได้ (-1 : ไม่จำกัด)
		...
		allowed_list = {						-- รายการ whitelist/blacklist ต่างๆ
			...
			items = {
				type = 'blacklist',				-- default|whitelist|blacklist
				list = {						-- รายการของสิ่งของทั่วไป (ชนิดของรายการเป็น Array)

				}
			},
			weapons = {
				type = 'whitelist',				-- default|whitelist|blacklist
	...
	['trunk'] = {								-- ช่องเก็บของท้ายรถ
		action_radius = 2.0,					-- ระยะที่สามารถเปิดท้ายรถได้
		slot = -1,								-- จำนวนช่องทั้งหมดที่สามารถเก็บสิ่งของได้
		weight = 0,								-- จำนวนน้ำหนักทั้งหมดที่สามารถเก็บสิ่งของได้
		total_account_limit = 50000,			-- จำนวนสูงสุดของสิ่งของประเภทเงินที่สามารถเก็บได้ (-1 : ไม่จำกัด)
		total_item_limit = 40,					-- จำนวนสูงสุดของสิ่งของทั่วไปที่สามารถเก็บได้ (-1 : ไม่จำกัด)
		total_weapon_limit = 5,					-- จำนวนสูงสุดของอาวุธที่สามารถเก็บได้ 1 ชิ้น/ช่อง (-1 : ไม่จำกัด)
		allow_accounts = true,					-- การเปิดใช้งานให้สามารถเก็บสิ่งของประเภทเงินได้
		allow_items = true,					-- การเปิดใช้งานให้สามารถเก็บสิ่งของทั่วไปได้
		allow_weapons = true,					-- การเปิดใช้งานให้สามารถอาวุธได้
		allowed_list = {						-- รายการ whitelist/blacklist ต่างๆ
