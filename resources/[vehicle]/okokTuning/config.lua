...
Config.UseMoneyAccount = "money" -- What account to use when paying bills
...
Config.PricingPercentage = 0.0          -- Decimal Percentage of the Vehicles Price Impact on the Option price
...
Config.Zones = {
      ...
      --     name        = "SOS Tuning",
      --     jobs        = { "police" },
      --     coords      = vector3(478.3200073242188, -1023.3800048828124, 28.04000091552734),
      --     size        = vector3(5, 5, 5),
      --     rotation    = 70,
      --     type        = "job",
      --     debug       = false,
      ...
      --{
      --     name        = "Auto Tuning",
      --     coords      = vector3(-468.8599853515625, 1101.0999755859375, 327.8699951171875),
      --     size        = vector3(5, 5, 5),
      --     rotation    = 70,
      --     type        = "selfservice",
      --     debug       = false,
      ...
      --     blipScale   = 0.7,
      --     blipEnabled = false,
      --     premium     = 0, -- 10% premium price for selfservice zones (more expensive)
      --},
      --{
      --     name        = "Auto Tuning",
      --     coords      = vector3(-466.7900085449219, 1108.8499755859375, 327.8699951171875),
      --     size        = vector3(5, 5, 5),
      --     rotation    = 70,
      --     type        = "selfservice",
      --     debug       = false,
...
Config.ExtraStuff = {
      ...
      Plates = {
            { name = Locale("BlueOnWhite1"),  id = 0, price = 1000 },
            { name = Locale("BlueOnWhite2"),  id = 3, price = 1000 },
            { name = Locale("BlueOnWhite3"),  id = 4, price = 1000 },
            { name = Locale("YellowOnBlue"),  id = 2, price = 1000 },
            { name = Locale("YellowOnBlack"), id = 1, price = 1000 },
            { name = Locale("Yankton"),       id = 5, price = 1000 },
      },

      WindowTintOptions = {
            { name = Locale("None"),       id = 0, price = 0 },
            { name = Locale("LightSmoke"), id = 3, price = 1000 },
            { name = Locale("DarkSmoke"),  id = 2, price = 1000 },
            { name = Locale("PureBlack"),  id = 1, price = 1000 },
      },
      ...
      BulletProofTyresPrice = 999999999,
      TyreSmokePrice = 1000,
...
Config.HornPreviewDuration = 1000
