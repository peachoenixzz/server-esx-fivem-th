...
Config.Event = {
	[1] = {		-- ไอดีของกิจกรรม
		Gameplay = {
			hunter_weapon = 'WEAPON_CARBINERIFLE',		-- ชื่ออาวุธที่ Hunter จะได้รับ
			hunter_weapon_ammo = 300,		-- จำนวนกระสุนที่ Hunter จะได้รับ
			...
			time = {
				start = 3,		-- เวลารอผู้เล่นเข้าร่วมกิจกรรม (หน่วยเป็นนาที)
	...
	[2] = {		-- ไอดีของกิจกรรม
		Gameplay = {
			...
			hunter_weapon_ammo = 300,		-- จำนวนกระสุนที่ Hunter จะได้รับ
			map = 'house_1',		-- ชื่อแมพจาก Config.Map
			player_min = 16,		-- จำนวนผู้เล่นขั้นต่ำ (ห้ามต่ำกว่า 2 คน)
			player_max = 30,		-- จำนวนผู้เล่นสูงสุด
			player_hunter = 7 ,		-- จำนวนคนหาต่อรอบ (ผู้เล่นที่เหลือจะเป็นคนซ่อนทั้งหมด)
			round_limit = 2,		-- จำนวนรอบที่จะเล่น

			time = {
				start = 1,		-- เวลารอผู้เล่นเข้าร่วมกิจกรรม (หน่วยเป็นนาที)
				hide = 1,		-- เวลาในการซ่อน (หน่วยเป็นนาที)
				in_game = 8,		-- เวลาในการเล่นของรอบนั้นๆ (หน่วยเป็นนาที)
				next_round = 10,		-- เวลารอรอบต่อไป (หน่วยเป็นวินาที)
			},
		...
		StartTime = {
			hour = 23,		-- เวลาที่จะให้เริ่มกิจกรรมอัตโนมัติ (ชั่วโมง)
			minute = 00		-- เวลาที่จะให้เริ่มกิจกรรมอัตโนมัติ (นาที)
		},
