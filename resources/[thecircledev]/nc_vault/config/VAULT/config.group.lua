	...
	['TENT'] = {
		...
		zone = {
			...
			locations = {
				...
				{
					model = ``,
					coords = vector3(-3157.27001953125, 1085.719970703125, 20.79999923706054), -- แปรรูปเหล็ก
					heading = 0.0,
					z_offset = 0.0,
					text_z_offset = 0.1,
					place_on_ground = false,
				...
				{
					model = ``,
					coords = vector3(-415.6199951171875, 2931.89990234375, 15.40999984741211), -- จุดขุดทอง
					heading = 0.0,
					z_offset = 0.0,
					text_z_offset = 0.1,
					place_on_ground = false,
				...
				{
					model = ``,
					coords = vector3(-72.22000122070312, 1889.8800048828127, 196.7400054931641), -- แปรรูปไม้
					heading = 0.0,
					z_offset = 0.0,
					text_z_offset = 0.1,
					place_on_ground = false,
