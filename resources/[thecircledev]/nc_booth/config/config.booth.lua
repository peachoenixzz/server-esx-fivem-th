...
Config.Zones = {
	[1] = {
		coords = vector3(-2830.260009765625, -1944.7900390625, 6.17000007629394), -- ตำแหน่งของ Economy Shop
...
Config.Items = {{
					...
					sell_action = {
						items = {
							...
							"box_exp", "box_gunpart", "gacha_w1", "w1_money", "w1_eco", "w1_material", "w1_exp", "w1_illegal", "w1_mix", "w1_weapon",
							"w1_special", "engine", "gear", "steering", "turbo", "wheel", "engine_g", "gear_g", "steering_g", "turbo_g", "wheel_g",
							"box_turismo3", "box_brawler", "box_trophy", "box_supstore", "sk_1", "sk_2", "sk_3", "box_evidence", "card_farm", "box_rcar3",
							"coin_loser", "gacha_gov", "gov_ticket", "box_polbmwm4", "box_polr34", "tracker", "box_goldknifed", "gov_curfew", "coin_unlucky",
							"gov_adrenaline", "vault_pdm", "gov_card", "exp_gov", "toptier_box"}
						},
						weapons = {
							type = 'blacklist', -- default|blacklist|whitelist
							...
							"WEAPON_KNUCKLEGOLD", "WEAPON_MACHETTEGOLD", "WEAPON_GUTKNIFELPGOLD", "WEAPON_POOLGOLD", "WEAPON_KNIFE_SOS","WEAPON_POOLCUE_SOS",
							"WEAPON_REVOLVER_V1", "WEAPON_REVOLVER_V2", "WEAPON_REVOLVER_V3"}
						}
					},
...
Config.Storages = {
	...
	locations = {{
					 title_z_offset = 1.4,
					 coords = vector3(-2828.300048828125, -1930.199951171875, 5.8600001335144),
					 heading = 181.29,
					 model = {
