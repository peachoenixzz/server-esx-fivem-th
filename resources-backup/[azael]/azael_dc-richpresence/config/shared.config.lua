...
CONFIG.Discord = {                                          -- Discord
    Application = {                                         -- Application (Developer Portal: https://discord.com/developers/applications)
        ID = 1113917644463161364                             -- ID (รูปภาพตัวอย่าง: https://i.imgur.com/cWZjHB3.png)
    },
    ...
    Asset = {                                               -- Asset (Art Assets: https://discord.com/developers/applications/YOUR_APP_ID/rich-presence/assets)
        Logo = {                                            -- ภาพสัญลักษณ์ (ขนาดปกติ)
            Name = 'https://mongkol.dev/images/logo-mongkol.png',                            -- ชื่อ (รูปภาพตัวอย่าง: https://imgur.com/y1Amkyu.png)
            Text = 'Mongkol Town'                    -- ข้อความ
        },

        Icon = {                                            -- ภาพสัญลักษณ์ (ขนาดเล็ก)
            Name = 'https://mongkol.dev/images/logo-mongkol.png',                            -- ชื่อ (รูปภาพตัวอย่าง: https://i.imgur.com/0STQ7rh.png)
            Text = 'Mongkol Town'                    -- ข้อความ
        }
    },
    ...
    Button = {                                              -- Button (ปุ่ม)
        [1] = {                                             -- ปุ่มที่ 1
            ...
            URL = 'https://discord.gg/zP3SbCeGfb'               -- URL
        },

        [2] = {                                             -- ปุ่มที่ 2
            Text = 'Join Server',                           -- ข้อความ
            URL = 'fivem://connect/https://sv.mongkol.dev/'         -- URL
        }
    }
}
