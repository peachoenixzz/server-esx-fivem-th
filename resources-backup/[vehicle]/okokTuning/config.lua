...
Config.PricingMethod = "percentage"      -- "fixed" = Fixed price per category | "percentage" = Percentage of the base price
Config.PricingPercentage = 0.01          -- Decimal Percentage of the Vehicles Price Impact on the Option price
...
Config.Zones = {
      ...
      --{
      --      name        = "Auto Tuning",
      --      coords      = vector3(-465.7099914550781, 1108.18994140625, 327.8699951171875),
      --      size        = vector3(5, 5, 5),
      --      rotation    = 70,
      --      type        = "selfservice",
      --      debug       = false,
