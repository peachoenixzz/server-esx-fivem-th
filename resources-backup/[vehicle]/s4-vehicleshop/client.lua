...
<<<<<<< HEAD:resources-backup/[vehicle]/s4-vehicleshop/client.lua
                    local xVehicle = CreateVehicle(veh.name, curGarage.deliveryCoord, true, false)
=======
                DoScreenFadeOut(800)
                ...
                DoScreenFadeIn(800)
                Wait(100)
                ESX.Game.SpawnVehicle(GetHashKey(veh.name), curGarage.deliveryCoord, 197.85, function(xVehicle)
                    --local xVehicle = CreateVehicle(veh.name, curGarage.deliveryCoord, true, false)
>>>>>>> 5ee49c5c7a9080ee86b1a53abb5a738bfdfdfe36:resources-bakkk/[vehicle]/s4-vehicleshop/client.lua
                    local newPlate = GeneratePlate()
                    local  vehicleClass = GetVehicleClassFromName(veh.name)
                    local vehicleType = ""
