...
Config.Storages.Models['SHABUTRAIN'] = {
	...
	['trunk'] = {								-- ช่องเก็บของท้ายรถ
		action_radius = 2.5,					-- ระยะที่สามารถเปิดท้ายรถได้
		slot = 100,								-- จำนวนช่องทั้งหมดที่สามารถเก็บสิ่งของได้
		weight = 61,								-- จำนวนน้ำหนักทั้งหมดที่สามารถเก็บสิ่งของได้
