...
Config.Inventory = 'custom' -- ch = Cheeza Inventory / qb = QBCore basic inventory / custom / qs = Quasar Inventory / ox = Ox_inventory
Config.DrawMakerStockage = true -- Choose to draw a marker at the location of each storage for trailers

Config.UseMetro = true
...
Config.TrainShop = {
    ["Stock"] = {
        ...
        traintobuy = {19, 20},
        job = "admin" -- Remove this line if none
    },
