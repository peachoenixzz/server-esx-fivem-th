...
Config.MinimumStoreRobberyPolice = 10
...
--ปรับเวลา
SvConfig.resetTime = (60 * 1000) * 30
SvConfig.tickInterval = 300000

Config.cashierItem = {
    [1] = {
        useItem = true,                             -- เปิดปิดการใช้ไอเทมเพื่อมเริ่มงาน
        useItemName = 'money_dummy_1000',                      -- ชื่อไอเทมที่ใช้เริ่มงาน

        getItemName =
        {
            {
                itemName = {'black_money', 'money', 'diamond'},
                itemCount = {3, 5},
                moneyCount = {5000, 5000}
            },
            {
                itemName = {'money', 'diamond'},
                itemCount = {3, 5},
                moneyCount = {5000, 5000}
            },
            {
                itemName = {'black_money', 'diamond'},
                itemCount = {3, 5},
                moneyCount = {5000, 5000}
            },                  -- ชื่อไอเทมที่ได้รับ
        },
...
SvConfig.ItemSafe = {
	-- {item = "aed", amount = 1, rate = 2},
	{item = "cigarette", amount = 5, rate = 2},
	{item = "zippo", amount = 2, rate = 2},
	{item = "cocaine", amount = 3, rate = 20},
	{item = "cocaine_pro", amount = 2, rate = 20},
	{item = "weed", amount = 3, rate = 20},
	{item = "weed_pro", amount = 2, rate = 20},
	{item = "gold", amount = 1, rate = 10},
	{item = "gold", amount = 4, rate = 5},
	{item = "black_money", amount = 2000, rate = 20},
	{item = "cement", amount = 5, rate = 20},
	{item = "ghost_key", amount = 1, rate = 40},
	{item = "cheque_1k", amount = 1, rate = 80}
}