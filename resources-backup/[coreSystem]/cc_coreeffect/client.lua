...
RegisterNetEvent('core_effect_start:adrenaline_gov')
AddEventHandler('core_effect_start:adrenaline_gov', function()
    SetRunSprintMultiplierForPlayer(PlayerId(),1.49)
end)
...
RegisterNetEvent('core_effect_stop:adrenaline_gov')
AddEventHandler('core_effect_stop:adrenaline_gov', function()
    SetRunSprintMultiplierForPlayer(PlayerId(),1.0)
end)
