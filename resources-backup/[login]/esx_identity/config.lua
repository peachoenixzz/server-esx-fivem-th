...
Config.MinHeight        = 0 -- 120 cm lowest height
Config.MaxHeight        = 10000 -- 220 cm max height.
Config.LowestYear       = 0 -- 112 years old is the oldest you can be.
Config.HighestYear      = 9999 -- 18 years old is the youngest you can be.
