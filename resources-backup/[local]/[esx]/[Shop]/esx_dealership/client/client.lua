...
function OpenVehicleShop()
    ...
    --SetEntityCoords(ped, 404.90, -949.58, -99.71, 0, 0, 0, false)
	 ...
	 cam = CreateCamWithParams("DEFAULT_SCRIPTED_CAMERA", 4451.54, -4466.99, 4.33, 330.5, 0.00, 0.00, 60.00, false, 0)
    PointCamAtCoord(cam, 4446.11, -4467.06, 3.9)

    SetCamActive(cam, true)
    RenderScriptCams(true, true, 1, true, true)
        
    SetFocusPosAndVel(4451.54, -4466.99, 4.33, 0.0, 0.0, 0.0)
...
function updateSelectedVehicle(model)
  ...
  lastSelectedVehicleEntity = CreateVehicle(hash, 4446.09, -4467.09, 3.91, 330.5, 0, 1)
  ...
  --  SetVehicleCustomSecondaryColour(lastSelectedVehicleEntity,  rgbSecondaryColorSelected[1], rgbSecondaryColorSelected[2], rgbSecondaryColorSelected[3])
    SetEntityHeading(lastSelectedVehicleEntity, 330.5)
end
...
RegisterNUICallback(
    ...
    function(data, cb)        
        if Config.TestDrive then
            ...
            testDriveEntity = CreateVehicle(hash, -2061.51, 2880.61, 32.39, 60.09, 1, 1)
...
Citizen.CreateThread(function ()
    ...
    for i = 1, #vehicleshopCoords do    
		...
		SetBlipSprite (blip, 410) --477
		SetBlipDisplay(blip, 4)
		SetBlipScale  (blip, 1.0)
        SetBlipAsShortRange(blip, true)

        BeginTextCommandSetBlipName("STRING")
		AddTextComponentString('<font face="ThaiFont">ร้านขายรถ</font>')
