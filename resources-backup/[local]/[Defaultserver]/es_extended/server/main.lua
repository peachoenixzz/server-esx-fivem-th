...
local loadPlayer = 'SELECT u.accounts, u.job, u.job_grade, u.group, u.position, u.inventory, u.skin, u.loadout, u.metadata, v.priority'
...
function loadESXPlayer(identifier, playerId, isNew)
  ...
  local xPlayer = CreateExtendedPlayer(playerId, identifier, userData.group, userData.accounts, userData.inventory, userData.weight, userData.job,
    userData.loadout, userData.playerName, userData.coords, userData.metadata, userData.vip )
