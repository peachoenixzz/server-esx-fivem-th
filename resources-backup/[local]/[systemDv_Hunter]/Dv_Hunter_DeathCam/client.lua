...
function StartDeathCam()
    ...
    cam = CreateCamWithParams("DEFAULT_SCRIPTED_CAMERA", GetPlayerCoordsAsync(), 0, 0, 0, GetGameplayCamFov())
...
function ProcessCamControls()
    --local playerPed = PlayerPedId()
    local playerCoords = GetPlayerCoordsAsync()
...
function ProcessNewPosition()
    ...
    local pCoords = GetPlayerCoordsAsync()
