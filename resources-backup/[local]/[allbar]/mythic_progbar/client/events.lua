...
RegisterNetEvent("mythic_progbar:client:ProgressWithTickArea")
AddEventHandler("mythic_progbar:client:ProgressWithTickArea", function(action, tick, finish)
	ProgressTickArea(action, nil, tick, finish)
end)
...
RegisterNetEvent("mythic_progbar:client:ProgressCleanUp")
AddEventHandler("mythic_progbar:client:ProgressCleanUp", function()
