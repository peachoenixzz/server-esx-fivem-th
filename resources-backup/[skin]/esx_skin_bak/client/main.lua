...
AddEventHandler('esx_skin:getLastSkinDefault', function(cb) cb(lastSkin) end)
AddEventHandler('esx_skin:setLastSkinDefault', function(skin) lastSkin = skin end)

RegisterNetEvent('esx_skin:openMenuDefault')
AddEventHandler('esx_skin:openMenuDefault', function(submitCb, cancelCb)
    OpenMenu(submitCb, cancelCb, nil)
end)

RegisterNetEvent('esx_skin:openRestrictedMenuDefault')
AddEventHandler('esx_skin:openRestrictedMenuDefault', function(submitCb, cancelCb, restrict)
    OpenMenu(submitCb, cancelCb, restrict)
end)

RegisterNetEvent('esx_skin:openSaveableMenuDefault')
AddEventHandler('esx_skin:openSaveableMenuDefault', function(submitCb, cancelCb)
    OpenSaveableMenu(submitCb, cancelCb, nil)
end)

RegisterNetEvent('esx_skin:openSaveableRestrictedMenuDefault')
AddEventHandler('esx_skin:openSaveableRestrictedMenuDefault', function(submitCb, cancelCb, restrict)
    OpenSaveableMenu(submitCb, cancelCb, restrict)
end)

RegisterNetEvent('esx_skin:requestSaveSkinDefault')
AddEventHandler('esx_skin:requestSaveSkinDefault', function()
    TriggerEvent('skinchanger:getSkin', function(skin)
