RegisterServerEvent('esx_skin:saveDefault')
AddEventHandler('esx_skin:saveDefault', function(skin)
...
RegisterServerEvent('esx_skin:responseSaveSkinDefault')
AddEventHandler('esx_skin:responseSaveSkinDefault', function(skin)
	local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('esx_skin:getPlayerSkinDefault', function(source, cb)
	local xPlayer = ESX.GetPlayerFromId(source)
