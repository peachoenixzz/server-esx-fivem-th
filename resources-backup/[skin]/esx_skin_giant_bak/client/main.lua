...
function OpenSaveableMenu(submitCb, cancelCb, restrict)
	...
	OpenMenu(function(data, menu)
		...
		TriggerEvent('skinchanger:getSkin', function(skin)
			TriggerServerEvent('esx_skin_giant:save', skin)
...
--	end)
--end)
RegisterNetEvent('esx_skin_giant:afterSave')
AddEventHandler('esx_skin_giant:afterSave', function()
	TriggerEvent('skinchanger:getSkin', function(skin)
		print("skin : ",skin.sex)
		if skin.sex == 1 then
...
AddEventHandler('esx_skin:requestSaveSkin', function()
	TriggerEvent('skinchanger:getSkin', function(skin)
		TriggerServerEvent('esx_skin_giant:responseSaveSkin', skin)
	end)
end)
