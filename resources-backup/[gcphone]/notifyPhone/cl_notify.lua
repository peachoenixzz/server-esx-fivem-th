...
RegisterNetEvent("GCPhonepNotify:SendNotification")
AddEventHandler("GCPhonepNotify:SendNotification", function(options)
	
    SendNotification(options)
end)

RegisterNetEvent("GCPhonepNotify:SetQueueMax")
AddEventHandler("GCPhonepNotify:SetQueueMax", function(queue, max)
