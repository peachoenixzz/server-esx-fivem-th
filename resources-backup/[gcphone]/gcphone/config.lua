...
Config.Locale       = 'en'
Config.Phones       = "Phone"
Config.Useitem = true -- true  = ใช้ไอเท็มในกาเปิดโทรศัพ  false = ไม่ใช้ไอเท็มในกาเปิดโทรศัพ

function ChecknotPhone()
    onNoPhone()
end

Config.FourDigit = true

Config.DiscordWephook = "https://discordapp.com/api/webhooks/980663208161472542/CPr87PrhjvoTZ6gMr5XsRv1t_e_EypzV39AqX9qEMxW3I70x0PQdgf_tr7C_QJ9EnZQv"
...
function onNoPhone()
    exports.nc_notify:PushNotification({
        ...
        description = 'คูณไม่มีโทรศัทพ์', -- รายละเอียด หากต้องการให้แสดงปุ่มกดให้ใช้ tag <btn></btn>
        type = 'warning', -- ชนิดของ Notify * หากไม่ใส่จะเป็น 'info'
        position = 'top', -- ตำแหน่งการแสดง ('top': บน | 'bottom': ล่าง) * หากไม่ใส่จะเป็น 'top'
        direction = 'right', -- ตำแหน่งการแสดง ('left': ซ้าย | 'center': กลาง' | 'right': ขวา) * หากไม่ใส่จะเป็น 'right'
        priority = 'medium', -- ความสำคัญของ Notify นั้นๆ high จะอยู่บน และ low จะอยู่ล่าง * หากไม่ใส่จะเป็น 'medium'
        icon = 'no_phone', -- Icon (html/img/icons) ที่ต้องการให้แสดง (ใช้ไม่ได้กับ category = 'item')
